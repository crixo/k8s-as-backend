...
func (ws WebhookServer) ensureValidationWebhook(i *k8sasbackendv1alpha1.K8sAsBackend) (*reconcile.Result, error) {
	resUtils := &common.ResourceUtils{
		Scheme:          ws.Scheme,
		Client:          ws.Client,
		ResourceFactory: createValidationWebhook,
	}

	nsn := types.NamespacedName{Name: ValidationWebhookName, Namespace: ""}
	found := &arv1beta1.ValidatingWebhookConfiguration{}
	return nil, common.EnsureResource(found, nsn, i, resUtils)
}

func createValidationWebhook(nsName types.NamespacedName, i *k8sasbackendv1alpha1.K8sAsBackend) runtime.Object {
